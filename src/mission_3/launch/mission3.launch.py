...
def generate_launch_description():
    ...
    detection_node = Node(
        package='mission_3',
        executable='task_3_detection_node',
        name='mission3_detection_node',
        output='screen',
        parameters=[{
    ...
    manager_node = Node(
        package='mission_3',
        executable='task_3_manager_node',
        name='mission3_task_manager_node',
        output='screen',
        parameters=[{
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('weights_path', default_value='/home/seungwon/soomac_ws/src/mission_3/mission_3/best.pt'),
        DeclareLaunchArgument('handeye_path', default_value='/home/seungwon/soomac_ws/src/mission_3/mission_3/hand_eye_result.json'),
        ...
        DeclareLaunchArgument('target_waypoint', default_value='cleanup_zone'),
